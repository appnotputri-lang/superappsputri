...
const categories = [
  ...
  { letter: 'U', name: 'AKTIVITAS RUMAH TANGGA SEBAGAI PEMBERI KERJA DAN AKTIVITAS PRODUKSI BARANG DAN JASA OLEH RUMAH TANGGA UNTUK KEPERLUAN SENDIRI YANG TIDAK TERDIFERENSIASI', min: '97', max: '98' },
