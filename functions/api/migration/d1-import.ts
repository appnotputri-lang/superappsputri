...
export const onRequestPost = async (context: any) => {
  ...
  try {
    ...
    return createJsonResponse({
      ...
      firestoreReadCount: 0, // Strictly ZERO reads from Firestore!
      invoices: {
