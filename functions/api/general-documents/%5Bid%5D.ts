...
export const onRequestGet = async (context: any) => {
  ...
  try {
    ...
    console.error("[CF General Documents API] Error fetching general document by ID:", error);
    return createErrorResponse(error?.message || "Failed to fetch general document", 500);
  }
};
...
export const onRequestPut = async (context: any) => {
  ...
  try {
    ...
    console.error("[CF General Documents API] Error updating general document:", error);
    return createErrorResponse(error?.message || "Failed to update general document", 500);
  }
};
...
export const onRequestDelete = async (context: any) => {
  ...
  try {
    ...
    console.error("[CF General Documents API] Error deleting general document:", error);
    return createErrorResponse(error?.message || "Failed to delete general document", 500);
  }
};
