...
export function generatePendirianBlocks(data: PendirianData): Block[] {
  ...
  blocks.push(
    ...
    { type: 'p', align: 'center', runs: [{ text: 'Nomor : 09' }] },
    { type: 'br' }
  );
  ...
  blocks.push(
    ...
    { type: 'pasal-divider', text: 'TEMPAT, PEMANGGILAN DAN PIMPINAN RAPAT UMUM PEMEGANG SAHAM' },
    { type: 'pasal-divider', text: 'PASAL' },
    { type: 'pasal-divider', text: ' 9' },
    ...
    { type: 'pasal-divider', text: 'KUORUM, HAK SUARA, DAN KEPUTUSAN RAPAT UMUM PEMEGANG SAHAM' },
    { type: 'pasal-divider', text: 'PASAL' },
    { type: 'pasal-divider', text: ' 10' },
