...
export interface AhuSectionProps {
  title: string;
  children: React.ReactNode;
  isOpen?: boolean;
}

export const AhuSection = ({ title, children, isOpen = true }: AhuSectionProps) => {
...
export interface AhuLabelProps {
  label: string;
  required?: boolean;
}

export const AhuLabel = ({ label, required = false }: AhuLabelProps) => (
...
export interface AhuMasaJabatanSelectorProps {
  data: any;
  updateData: (d: any) => void;
}

export const AhuMasaJabatanSelector = ({ data, updateData }: AhuMasaJabatanSelectorProps) => {
