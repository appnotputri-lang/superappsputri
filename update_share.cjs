...
content = content.replace(
  ...
  "Share2, Copy, Send } from 'lucide-react';"
);
...
// update the Share button in the Grid/List to open the modal and also add a Copy button
content = content.replace(
...
// We need to add the copy button to the grid/list as well since we replaced it.
// Actually, let's just use the menu for that, but we replaced it. Let's just restore Copy button in the menu.
